...
public class FindOrCreateConfigAsyncTestGui {
    ...
    public FindOrCreateConfigAsyncTestGui() {
                                ...
                                InteractiveConfigInitializer.findOrCreateConfigAsync(
                                        ...
                                        (res2, err2) -> {
                                            ...
                                            assertTrue(
                                                    cfgFile.delete(),
                                                    String.format(
                                                            "Failed to delete config file %s after findOrCreateConfigAsync created it",
