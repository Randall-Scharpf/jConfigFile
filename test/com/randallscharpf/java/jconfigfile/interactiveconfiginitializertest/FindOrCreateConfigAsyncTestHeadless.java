...
public class FindOrCreateConfigAsyncTestHeadless {
    ...
    private volatile ConfigFile helperResult;
    private volatile IOException helperError;
    ...
    public void testCreateNewFile(ConfigLocation loc) {
        assertDoesNotThrow(() -> {
            ...
            resultReady = false;
            InteractiveConfigInitializer.findOrCreateConfigAsync(getClass(), "jConfigFile_InteractiveConfigInitializerTest", (res, err) -> {
